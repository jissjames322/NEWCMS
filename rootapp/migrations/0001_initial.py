    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('AppointmentId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rootapp.appointment')),
            ],
        ),
        migrations.AddField(
            model_name='appointment',
            name='DoctorId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rootapp.doctor'),
        ),
        migrations.CreateModel(
            name='LabTest',
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('LabTestCategoryId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rootapp.labtestcategory')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('AppointmentId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rootapp.appointment')),
                ('LabTestId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rootapp.labtest')),
            ],
        ),
        migrations.CreateModel(
            name='Medicine',
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('MedicineCategoryId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rootapp.medicinecategory')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('AppointmentId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rootapp.appointment')),
                ('MedicineId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rootapp.medicine')),
            ],
        ),
        migrations.CreateModel(
            name='MedicineStock',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('MembershipId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rootapp.membership')),
            ],
        ),
        migrations.AddField(
            model_name='appointment',
            name='PatientId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rootapp.patient'),
        ),
        migrations.AddField(
            model_name='doctor',
            name='SpecializationId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rootapp.specialization'),
        ),
        migrations.CreateModel(
            name='Staff',
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('RoleId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rootapp.role')),
            ],
        ),
        migrations.AddField(
            model_name='doctor',
            name='StaffId',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='rootapp.staff'),
        ),
    ]
